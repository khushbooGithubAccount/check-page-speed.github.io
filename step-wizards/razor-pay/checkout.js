var Razorpay = (function () {
  ...
  (z.prototype.catch = function (e) {
    ...
    (z.resolve = function (e) {
      return e && "object" == typeof e && e.constructor === z
        ? e
        : new z(function (n) {
            n(e);
          });
  ...
  var en = function () {
    ...
    rn = ["rzp_test_1DP5mmOlF5G5ag", "rzp_live_ILgsfZCZoFIKMb"];
  var an = function () {
      try {
        if (nn()) return !0;
        var e = Be("disable_redesign_v15"),
          n = Oe("experiments.cb_redesign_v1_5"),
          t = Oe("experiments.recurring_redesign_v1_5"),
          r = Oe("experiments.checkout_redesign_v1_5"),
      ...
      if (!En(e, On))
        return function (a) {
          ...
          return (
            fn(t)
              ? (i = function (e) {
                  for (var r = e.target; !ot(r, t) && r !== a; ) r = Fn(r);
  ...
  try {
    p.assign(zt, l.Razorpay.config);
  } catch (e) {}
  var Kt = l !== l.parent,
    Ut = Kt ? l.parent : l.opener,
    $t = 3409537651,
    jt = "production",
    Ht = "c15c2810f99ef3fd51cbbe1a20598e286eff50c1";
  var Gt = (function () {
      try {
        var e = zt.api;
        return (
          Kt && ((n = zt.frameApi), ((St = Bn("a")).href = n), (e = St.href)),
    ...
    return (
      ...
      n
        ? (function (e, n) {
            return (
              void 0 === e && (e = ""),
              kt(zt.api + zt.version + "standard_checkout/" + e, {
                session_token: n,
              })
            );
          })(e, l.session_token)
    ...
    for (var n = {}, t = 0, r = e; t < r.length; t++) {
      ...
      if ($u.test(a.stem)) {
        ...
        a.stem.replace($u, function (e, t, r) {
          ...
          a.options.length && (n = zu(zu({}, n), Hu(a.options[0])));
      } else if (ju.test(a.stem)) n = zu(zu({}, n), Hu(a.stem));
      else {
        var i = Gu(a.stem);
        i && (n = zu(zu({}, n), i));
      }
  ...
  var Fc = {},
    ...
    Yc = function (e, n) {
      ...
      var u = (function (e, n) {
        if (n in Fc && e in Fc[n]) return Fc[n][e];
        var t = zc(e, n);
        return t
          ? (function (e, n, t) {
              return t
                ? (n in Fc || (Fc[n] = {}), e in Fc[n] || (Fc[n][e] = t), t)
                : t;
            })(e, n, t)
          : null;
      })(e, i);
  ...
  var rs = {
    ...
    omnichannel: function () {
      return !Je() && !ze() && Ze("google_pay_omnichannel");
    },
    qr: function () {
      var e =
        !ze() &&
  ...
  (ds.postInit = xa),
    ...
    (ds.calculateFees = function (e) {
      ...
      return new Promise(function (t, r) {
        (e = pi(e, n)),
          _t.post({
            url: zo("payments/calculate/fees"),
            data: e,
            callback: function (e) {
    ...
    (ds.fetchVirtualAccount = function (e) {
      ...
      return new Promise(function (e, a) {
        if (t) {
          ...
          var o = zo("orders/" + t + "/virtual_accounts?x_entity_id=" + t);
          _t.post({
            url: o,
            data: i,
            callback: function (n) {
  ...
  (ls.configure = function (e, n) {
    void 0 === n && (n = {}),
      ...
      n.library &&
        ((Er.props.library = n.library), ti.setContext(za, n.library)),
      n.referer &&
    ...
    return {
      c: function () {
        (n = Li("button")),
          ...
          Fi(t, "width", "12"),
          Fi(t, "height", "15"),
          Fi(t, "viewBox", "0 0 12 15"),
          Fi(t, "fill", "none"),
          Fi(t, "xmlns", "http://www.w3.org/2000/svg"),
          Fi(t, "class", "icon"),
          Fi(n, "id", "razorpay-magic-btn"),
          zi(n, "width", e[0], 1),
          zi(n, "border-radius", e[1], 1),
          zi(n, "background-color", e[2], 1),
          Fi(n, "data-testid", "razorpay-magic-btn");
      },
      m: function (s, l) {
        var m, f, p, h;
        Ti(s, n, l),
      ...
      p: function (e, t) {
        ...
        l
          ...
          (!o || 1 & r) && zi(n, "width", e[0], 1),
          (!o || 2 & r) && zi(n, "border-radius", e[1], 1),
          (!o || 4 & r) && zi(n, "background-color", e[2], 1);
      },
      i: function (e) {
        o || (eo(d, e), (o = !0));
      },
  ...
  var Ls,
    ...
    Hs = {
      ...
      orientationchange: function () {
        Hs.resize.call(this), Hs.scroll.call(this);
      },
      resize: function () {
        var e = l.innerHeight || Ks.height;
        (Zs.container.style.position = e < 450 ? "absolute" : "fixed"),
  ...
  function Vs(e) {
    try {
      Zs.backdrop.style.background = e;
    } catch (e) {}
  }
  function Zs(e) {
    if (((Ls = d.body), (Os = d.head), (Bs = Ls.style), e))
  ...
  Zs.prototype = {
    ...
    openRzp: function (e) {
      ...
      Fs ||
        ...
        e !== this.rzp && (Fn(n) !== r && Gn(r, n), (this.rzp = e)),
        (function () {
        ...
        t
          ...
          : (tt(Zn(r, "display", "block")),
            Vs(e.get("theme.backdrop_color")),
            /^rzp_t/.test(e.get("key")) &&
              Zs.ribbon &&
              (Zs.ribbon.style.opacity = 1),
    ...
    close: function () {
      Vs(""),
        Zs.ribbon && (Zs.ribbon.style.opacity = 0),
        (function (e) {
          e && e.forEach(Yn);
          var n = Gs();
          n && n.forEach(Hn(Os));
        })(this.$metas),
        (Bs.overflow = Hs.overflow),
        this.unbind(),
        $s && Us(0, Hs.oldY),
        Ms(),
        Er.flush();
    ...
    bind: function () {
      ...
      if (!this.listeners) {
        ...
        var n = {};
        $s &&
          ((n.orientationchange = Hs.orientationchange),
          this.rzp.get("parent") || (n.resize = Hs.resize)),
          ke(n, function (n, t) {
    ...
    setMetaAndOverflow: function () {
      Os &&
        ...
        this.$metas.forEach(Hn(Os)),
        (Hs.overflow = Bs.overflow),
        (Bs.overflow = "hidden"),
        $s &&
          ((Hs.oldY = l.pageYOffset),
          l.scrollTo(0, 0),
          Hs.orientationchange.call(this)));
    },
    ...
    onload: function (e) {
      e && "checkout-frame" === e.origin && ((js = !0), (ss = !0)),
    ...
    onblur: function () {
      (this.isFocused = !1), Hs.orientationchange.call(this);
    },
    onrender: function () {
      Fs && (Yn(Fs), (Fs = null)), this.rzp.emit("render");
    },
    onevent: function (e) {
    ...
    oncomplete: function (e) {
      ...
      t && this.ongaevent({ event: Ps, category: Ns }),
        r && this.onfbaevent({ event: Ps, category: Ns }),
        this.close();
      var a = this.rzp,
        i = a.get("handler");
    ...
    onpaymenterror: function (e) {
      ...
      var n = this.rzp.get(),
        t = n.enable_ga_analytics,
        r = n.enable_fb_analytics;
      t && this.ongaevent({ event: Ds, category: Ns }),
        r && this.onfbaevent({ event: Ds, category: Ns });
      try {
        var a,
    ...
    afterClose: function () {
      Ms(), (Zs.container.style.display = "none");
    },
    onflush: function (e) {
      Er.flush(e);
    },
  ...
  ni(Qs, { skipEvents: !0 }), ni(Xs, { skipEvents: !0 });
  var nl,
    tl = kn(ls);
  function rl(e) {
    return function n() {
      return nl ? e.call(this) : (g(n.bind(this), 99), this);
    };
  }
  !(function e() {
    (nl = d.body || d.getElementsByTagName("body")[0]) || g(e, 99);
  })();
  var al,
    il = d.currentScript || (al = Nt("script"))[al.length - 1];
  function ol(e) {
    var n = Fn(il);
          ...
          Gn(
            ...
            if (fn(r) && r && !o.callback_url) {
              ...
              try {
                ...
                o.callback_url = zo("checkout/onyx") + "?data=" + c;
              } catch (e) {}
            }
  ...
  var dl,
    ...
    fl =
      ...
      (null == dl ? void 0 : dl.id) ? dl.id : null);
  function pl(e) {
    return (
      cl
        ? cl.openRzp(e)
        : ((cl = new Zs(e)),
          (Yt.iframeReference = cl.el),
          Yt.setId(Er.id),
          ut("message", cl.onmessage.bind(cl))(l),
          Gn(ul, cl.el)),
      cl
    );
  }
  ha().then(function (e) {
    ...
    (tl.postInit = function () {
      (this.modal = { options: {} }), this.get("parent") && this.open();
    });
  var hl = tl.onNew;
  (tl.onNew = function (e, n) {
    "payment.error" === e && Er(this, "event_paymenterror", P.href),
      pn(hl) && hl.call(this, e, n);
  }),
    (tl.initAndPrefetchPrefs = function () {
      return cl.prefetchPrefs(this), this;
    }),
    (tl.createCheckoutAndFetchPrefs = function (e) {
      cl
        ? cl.makeCheckoutCallForShopify(this, e)
        : this.emit("shopify_failure");
    }),
    (tl.open = rl(function () {
      this.metadata ||
        ((this.metadata = { isBrave: ml }),
        fl && (this.metadata.affordability_widget_fid = fl)),
        (this.metadata.openedAt = _.now());
      var e,
        n = (this.checkoutFrame = pl(this));
      Er(this, "open");
      try {
        el.INVOKED({
          prefill: {
      ...
      return (
        ...
        "-new.js" === il.src.slice(-7) && Er(this, "oldscript", P.href),
        this
      );
    })),
    (tl.resume = function (e) {
  ...
  var vl = rl(function () {
    ll(), window.Intl ? (cl = pl()) : jr.Track($r);
    try {
      sl();
    } catch (e) {}
  });
